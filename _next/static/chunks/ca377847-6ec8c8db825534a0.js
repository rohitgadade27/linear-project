...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [7674], {
        46136: function(t, e, i) {
            ...
            class y {
                static# t = this.defaults = {};
                static# e = this.datasetElementType = null;
                static# i = this.dataElementType = null;
                constructor(t, e) {
                ...
                _dataCheck() {
                    ...
                    if ((0, s.i)(e)) this._data = function(t) {
                        ...
                        let a = Object.keys(t),
                            n = Array(a.length);
                        for (e = 0, i = a.length; e < i; ++e) s = a[e], n[e] = {
                            x: s,
                            y: t[s]
                        };
                        return n
            ...
            function D(t, e, i, s) {
                var a;
                return t = s ? P(t = (a = t) === e ? i : a === i ? e : a, i, e) : P(t, e, i)
            }
            ...
            class S extends y {
                static# t = this.id = "bar";
                static# e = this.defaults = {
                ...
                updateElements(t, e, i, a) {
                    ...
                    for (let g = e; g < e + i; g++) {
                        ...
                        ! function(t, e, i, s) {
                            ...
                            "middle" === h && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? h = p : (i._bottom || 0) === s ? h = f : (d[D(f, c, u, g)] = !0, h = p)), d[D(h, c, u, g)] = !0, t.borderSkipped = d
                        }(m, x, f, r),
                        function(t, {
                            inflateAmount: e
                        }, i) {
                ...
                _getStacks(t, e) {
                    let {
                        iScale: i
                    } = this._cachedMeta, a = i.getMatchingVisibleMetas(this._type).filter(t => t.controller.options.grouped), n = i.options.stacked, r = [], o = t => {
                        let i = t.controller.getParsed(e),
                            a = i && i[t.vScale.axis];
                        if ((0, s.k)(a) || isNaN(a)) return !0
                    };
                    for (let i of a)
                        if (!(void 0 !== e && o(i)) && ((!1 === n || -1 === r.indexOf(i.stack) || void 0 === n && void 0 === i.stack) && r.push(i.stack), i.index === t)) break;
            ...
            function N(t, e, i, a, n) {
                let r = [];
                return (n || t.isPointInArea(e)) && V(t, i, e, function(i, o, l) {
            ...
            function B(t, e, i, a, n, r) {
                ...
                }(t, e, i, a, n, r) : (o = [], V(t, i, e, function(t, i, a) {
                    let {
                        startAngle: r,
                        endAngle: l
                ...
                modes: {
                    index(t, e, i, a) {
                        let n = (0, s.z)(e, t),
                            ...
                            l = i.intersect ? N(t, n, r, a, o) : B(t, n, r, !1, a, o),
                            h = [];
            ...
            function K(t, e, i, a) {
                ...
                for (let l of t) {
                    ...
                    if (l.horizontal) {
                        let a = e.w * d,
                            r = h.size || t.height;
                        (0, s.h)(h.start) && (o = h.start), t.fullSize ? G(t, n.left, o, i.outerWidth - n.right - n.left, r) : G(t, e.left + h.placed, o, a, r), h.start = o, h.placed += a, o = t.bottom
                    } else {
                        let a = e.h * d,
                            o = h.size || t.width;
                        (0, s.h)(h.start) && (r = h.start), t.fullSize ? G(t, r, n.top, o, i.outerHeight - n.bottom - n.top) : G(t, r, e.top + h.placed, o, a), h.start = r, h.placed += a, r = t.right
                    }
                }
                e.x = r, e.y = o
            }
            var J = {
                ...
                update(t, e, i, a) {
                    ...
                    q(l.fullSize, g, c, p), q(h, g, c, p), q(d, g, c, p) && q(h, g, c, p),
                        function(t) {
                            let e = t.maxPadding;
                        ...
                        }(g), K(l.leftAndTop, g, c, p), g.x += g.w, g.y += g.h, K(l.rightAndBottom, g, c, p), t.chartArea = {
                            left: g.left,
                            top: g.top,
                            right: g.left + g.w,
                            bottom: g.top + g.h,
            ...
            function tr(t, e, i) {
                let s = t.canvas,
                    a = new MutationObserver(t => {
                        let e = !1;
                        for (let i of t) e = (e = e || tn(i.addedNodes, s)) && !tn(i.removedNodes, s);
                        e && i()
                    });
            ...
            function to(t, e, i) {
                let s = t.canvas,
                    a = new MutationObserver(t => {
                        let e = !1;
                        for (let i of t) e = (e = e || tn(i.removedNodes, s)) && !tn(i.addedNodes, s);
                        e && i()
                    });
                return a.observe(document, {
                    childList: !0,
            ...
            function tc(t, e, i) {
                ...
                return o.observe(n), tl.size || window.addEventListener("resize", td), tl.set(t, r), o
            }

            function tu(t, e, i) {
                i && i.disconnect(), "resize" === e && (tl.delete(t), tl.size || window.removeEventListener("resize", td))
            }
            ...
            class tf {
                static# t = this.defaults = {};
                static# e = this.defaultRoutes = void 0;
                tooltipPosition(t) {
                    let {
                        x: e,
                        y: i
            ...
            class tw extends tf {
                ...
                update(t, e, i) {
                    ...
                    this._convertTicksToLabels(l ? tv(this.ticks, o) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), r.display && (r.autoSkip || "auto" === r.source) && (this.ticks = function(t, e) {
                        ...
                        if (o > 0) {
                            ...
                            for (tm(e, d, c, (0, s.k)(a) ? 0 : l - a, l), t = 0, i = o - 1; t < i; t++) tm(e, d, c, r[t], r[t + 1]);
                ...
                calculateLabelRotation() {
                    ...
                    c + 6 > (t = a.offset ? this.maxWidth / r : g / (r - 1)) && (t = g / (r - (a.offset ? .5 : 1)), e = this.maxHeight - ty(a.grid) - n.padding - tM(a.title, this.chart.options.font), i = Math.sqrt(c * c + u * u), h = Math.max(o, Math.min(l, h = (0, s.U)(Math.min(Math.asin((0, s.S)((d.highest.height + 6) / t, -1, 1)), Math.asin((0, s.S)(e / i, -1, 1)) - Math.asin((0, s.S)(u / i, -1, 1))))))), this.labelRotation = h
                }
                ...
                fit() {
                    ...
                    if (r) {
                        ...
                        if (o ? (t.width = this.maxWidth, t.height = ty(n) + r) : (t.height = this.maxHeight, t.width = ty(n) + r), i.display && this.ticks.length) {
                            let {
                                first: e,
                                last: a,
                                widest: n,
                ...
                _getLabelSizes() {
                    ...
                    if (!t) {
                        let e = this.options.ticks.sampleSize,
                            i = this.ticks;
                        e < i.length && (i = tv(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length, this.options.ticks.maxTicksLimit)
                    }
                    return t
                }
                _computeLabelSizes(t, e, i) {
                    ...
                    let {
                        ctx: f,
                        _longestTextCache: m
                    } = this, x = [], b = [], _ = Math.floor(e / t_(e, i)), v = 0, y = 0;
                    for (a = 0; a < e; a += _) {
                ...
                _computeGridLineItems(t) {
                    ...
                    if ("top" === b) e = C(this.bottom), o = this.bottom - w, h = e - S, c = C(t.top) + S, g = t.bottom;
                    else if ("bottom" === b) e = C(this.top), c = t.top, g = C(t.bottom) - S, o = e + S, h = this.top + w;
                    else if ("left" === b) e = C(this.right), r = this.right - w, l = e - S, d = C(t.left) + S, u = t.right;
                    else if ("right" === b) e = C(this.left), d = t.left, u = C(t.right) - S, r = e + S, l = this.left + w;
                    else if ("x" === p) {
                ...
                _computeLabelItems(t) {
                    ...
                    let g = this.axis,
                        ...
                        S = [],
                        C = "middle";
                    if ("top" === f) r = this.bottom - D, o = this._getXAxisLabelAlignment();
                    else if ("bottom" === f) r = this.top + D, o = this._getXAxisLabelAlignment();
                    else if ("left" === f) {
                ...
                drawTitle() {
                    ...
                    let {
                        ...
                        if (t.isHorizontal()) {
                            ...
                            } else o = "center" === i ? (g.bottom + g.top) / 2 + m - e : tb(t, i, e);
                            n = c - h
                        } else {
                            if ((0, s.i)(i)) {
                                let t = Object.keys(i)[0],
                            ...
                            } else r = "center" === i ? (g.left + g.right) / 2 - x + e : tb(t, i, e);
                    ...
                    (0, s.Z)(e, a.text, 0, 0, r, {
                        ...
                        maxWidth: u,
                        rotation: g,
                        textAlign: (t = (0, s.a1)(l), (n && "right" !== i || !n && "right" === i) && (t = tx(t)), t),
                        textBaseline: "middle",
                        translation: [d, c]
                    })
                }
            ...
            class tD {
                constructor() {
                    this.controllers = new tk(y, "datasets", !0), this.elements = new tk(tf, "elements"), this.plugins = new tk(Object, "plugins"), this.scales = new tk(tw, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
                }
                add(...t) {
                ...
                _createDescriptors(t, e) {
                    let i = t && t.config,
                        ...
                        n = function(t) {
                            ...
                            for (let t = 0; t < s.length; t++) i.push(tP.getPlugin(s[t]));
                            let a = t.plugins || [];
            ...
            function tE(t, ...e) {
                ...
                for (let s of e) {
                    var i;
                    let e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && tL(t[0].toLowerCase());
                    if (e) return e
                }
            ...
            function tT(t) {
                ...
                e.plugins = (0, s.v)(e.plugins, {}), e.scales = function(t, e) {
                    ...
                    return Object.keys(a).forEach(e => {
                        ...
                        let l = tE(e, o, function(t, e) {
                                if (e.data && e.data.datasets) {
                                    let i = e.data.datasets.filter(e => e.xAxisID === t || e.yAxisID === t);
                                    if (i.length) return tO(t, "x", i[0]) || tO(t, "y", i[0])
                                }
                                return {}
            ...
            class tV {
                constructor(t) {
                    var e;
                    this._config = ((e = (e = t) || {}).data = tA(e.data), tT(e), e), this._scopeCache = new Map, this._resolverCache = new Map
                }
                get platform() {
                ...
                getOptionScopes(t, e, i) {
                    ...
                    let l = new Set;
                    e.forEach(e => {
                        t && (l.add(t), e.forEach(e => tI(l, t, e))), e.forEach(t => tI(l, a, t)), e.forEach(t => tI(l, s.a3[n] || {}, t)), e.forEach(t => tI(l, s.d, t)), e.forEach(t => tI(l, s.a6, t))
                    });
                    let h = Array.from(l);
                    return 0 === h.length && h.push(Object.create(null)), tz.has(e) && r.set(e, h), h
                }
                chartOptionScopes() {
                    let {
                        options: t,
            ...
            function tW(t, e) {
                return "top" === t || "bottom" === t || -1 === tH.indexOf(t) && "x" === e
            }
            ...
            let tQ = {},
                tX = t => {
                    let e = tY(t);
                    return Object.values(tQ).filter(t => t.canvas === e).pop()
                };
            ...
            class tG {
                static# t = this.defaults = s.d;
                static# e = this.instances = tQ;
                static# i = this.overrides = s.a3;
                static# s = this.registry = tP;
                static# a = this.version = "4.4.1";
                static# n = this.getChart = tX;
                static register(...t) {
                    tP.add(...t), tK()
                }
                static unregister(...t) {
                ...
                buildOrUpdateScales() {
                    ...
                    e && (n = n.concat(Object.keys(e).map(t => {
                        ...
                        (void 0 === n.position || tW(n.position, o) !== tW(e.dposition)) && (n.position = e.dposition), a[r] = !0;
                        let h = null;
                ...
                buildOrUpdateControllers() {
                    ...
                    for (this._removeUnreferencedMetasets(), t = 0, e = a.length; t < e; t++) {
                        ...
                        if (n.type && n.type !== r && (this._destroyDatasetMeta(t), n = this.getDatasetMeta(t)), n.type = r, n.indexAxis = e.indexAxis || tC(r, this.options), n.order = e.order || 0, n.index = t, n.label = "" + e.label, n.visible = this.isDatasetVisible(t), n.controller) n.controller.updateIndex(t), n.controller.linkScales();
                        else {
                ...
                render() {
                    !1 !== this.notifyPlugins("beforeRender", {
                        cancelable: !0
                    }) && (n.has(this) ? this.attached && !n.running(this) && n.start(this) : (this.draw(), t$({
                        chart: this
                    })))
                }
                draw() {
                ...
                destroy() {
                    ...
                    this._stop(), this.config.clearCache(), t && (this.unbindEvents(), (0, s.af)(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete tQ[this.id], this.notifyPlugins("afterDestroy")
                }
                toBase64Image(...t) {
            ...
            function tK() {
                return (0, s.F)(tG.instances, t => t._plugins.invalidate())
            }
            ...
            function tZ(t, e, i, a, n, r) {
                ...
                if (t.beginPath(), r) {
                    ...
                    t.moveTo(o, l);
                    let e = Math.cos(P) * u + o,
                        i = Math.sin(P) * u + l;
                    t.lineTo(e, i);
                    let s = Math.cos(S) * u + o,
                        a = Math.sin(S) * u + l;
                    t.lineTo(s, a)
                }
                t.closePath()
            ...
            class t0 extends tf {
                ...
                static# i = this.defaultRoutes = {
                    backgroundColor: "backgroundColor"
                };
                static# s = this.descriptors = {
                    _scriptable: !0,
                ...
                draw(t) {
                    ...
                    t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                        ...
                        function(t, e, i, a, n) {
                            ...
                            }(t, e, f), r || (tZ(t, e, i, a, f, n), t.stroke())
            ...
            function t6(t, e, i, a) {
                ...
                let {
                    ...
                    loop: u,
                    ilen: g
                } = t3(l, i, a), p = h.stepped ? s.ar : h.tension || "monotone" === h.cubicInterpolationMode ? s.as : t2, {
                    move: f = !0,
                    reverse: m
                } = a || {};
            ...
            function t4(t) {
                ...
                return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? t6 : t5
            }
            let t7 = "function" == typeof Path2D;
            class t8 extends tf {
                static# t = this.id = "line";
                static# e = this.defaults = {
                    borderCapStyle: "butt",
                ...
                draw(t, e, i, s) {
                    ...
                    (this.points || []).length && a.borderWidth && (t.save(), function(t, e, i, s) {
                        if (t7 && !e.options.segment) {
                            let a;
                            (a = e._path) || (a = e._path = new Path2D, e.path(a, i, s) && a.closePath()), t1(t, e.options), t.stroke(a)
                        } else ! function(t, e, i, s) {
                            let {
                                segments: a,
                                options: n
                            } = e, r = t4(e);
                            for (let o of a) t1(t, n, o.style), t.beginPath(), r(t, e, o, {
                                start: i,
                                end: i + s - 1
            ...
            class et extends tf {
                ...
                inXRange(t, e) {
                    return t9(this, t, "x", e)
                }
                inYRange(t, e) {
                    return t9(this, t, "y", e)
                }
                getCenterPoint(t) {
                    let {
                        x: e,
            ...
            class er extends tf {
                ...
                draw(t) {
                        ...
                        let e = ee(t),
                            ...
                            n = function(t, e, i) {
                                let a = t.options.borderWidth,
                                    ...
                                    r = (0, s.av)(a);
                                return {
                                    t: ei(n.top, r.top, 0, i),
                                    r: ei(n.right, r.right, 0, e),
                                    b: ei(n.bottom, r.bottom, 0, i),
                                    l: ei(n.left, r.left, 0, e)
                                }
                            }(t, i / 2, a / 2),
                            r = function(t, e, i) {
                                let {
                                ...
                                return {
                                    topLeft: ei(!h || l.top || l.left, r.topLeft, 0, o),
                                    topRight: ei(!h || l.top || l.right, r.topRight, 0, o),
                                    bottomLeft: ei(!h || l.bottom || l.left, r.bottomLeft, 0, o),
                                    bottomRight: ei(!h || l.bottom || l.right, r.bottomRight, 0, o)
                                }
                            }(t, i / 2, a / 2);
                        return {
                            outer: {
                    ...
                    }(this), l = (e = o.radius).topLeft || e.topRight || e.bottomLeft || e.bottomRight ? s.au : ea;
                    t.save(), (o.w !== r.w || o.h !== r.h) && (t.beginPath(), l(t, en(o, i, r)), t.clip(), l(t, en(r, -i, o)), t.fillStyle = a, t.fill("evenodd")), t.beginPath(), l(t, en(r, i)), t.fillStyle = n, t.fill(), t.restore()
                }
                inRange(t, e, i) {
                    return es(this, t, e, i)
                }
                inXRange(t, e) {
                    return es(this, t, null, e)
                }
                inYRange(t, e) {
                    return es(this, null, t, e)
                }
                getCenterPoint(t) {
                    let {
                        x: e,
            ...
            class eu {
                ...
                pathSegment(t, e, i) {
                    ...
                    }, t.arc(a, n, r, e.end, e.start, !0), !i.bounds
                }
                interpolate(t) {
                    let {
                        x: e,
            ...
            function eg(t, e, i) {
                let a = function(t) {
                        ...
                        if ("stack" === i) return function(t) {
                            let {
                                ...
                                index: i,
                                line: a
                            } = t, n = [], r = a.segments, o = a.points, l = function(t, e) {
                                let i = [],
                        ...
                        let n = (t.scale || {}).getPointPositionForValue ? function(t) {
                            let {
                                scale: e,
                                fill: i
                            } = t, a = e.options, n = e.getLabels().length, r = a.reverse ? e.max : e.min, o = "start" === i ? r : "end" === i ? e.options.reverse ? e.min : e.max : (0, s.i)(i) ? i.value : e.getBaseValue(), l = [];
                            if (a.grid.circular) {
                            ...
                            for (let t = 0; t < n; ++t) l.push(e.getPointPositionForValue(t, o));
                            return l
                        }(t) : function(t) {
                            let e;
                            let {
                                scale: i = {},
                                fill: a
                            } = t, n = (e = null, "start" === a ? e = i.bottom : "end" === a ? e = i.top : (0, s.i)(a) ? e = i.getPixelForValue(a.value) : i.getBasePixel && (e = i.getBasePixel()), e);
                            if ((0, s.g)(n)) {
                        ...
                        return n instanceof eu ? n : ed(n, a)
                    }(e),
                    {
                        line: n,
                        scale: r,
                ...
                a && n.points.length && ((0, s.Y)(t, i), function(t, e) {
                    let {
                        line: i,
                        target: s,
                        above: a,
                    ...
                    t.save(), "x" === l && n !== a && (ep(t, s, r.top), ef(t, {
                        line: i,
                        target: s,
                        color: a,
                        scale: o,
                        property: l
                    }), t.restore(), t.save(), ep(t, s, r.bottom)), ef(t, {
                        line: i,
                        target: s,
                        color: n,
                        scale: o,
            ...
            function ep(t, e, i) {
                ...
                for (let o of (t.beginPath(), s)) {
                    ...
                    } = o, h = a[s], d = a[el(s, l, a)];
                    n ? (t.moveTo(h.x, h.y), n = !1) : (t.lineTo(h.x, i), t.lineTo(h.x, h.y)), (r = !!e.pathSegment(t, o, {
                        move: r
                ...
                for (let {
                        ...
                        for (let t of a) {
                            ...
                            for (let a of (0, s.an)(e, h)) {
                                let e = eo(i, r[a.start], r[a.end], a.loop);
                                for (let r of (0, s.ax)(t, n, e)) o.push({
                                    source: r,
                                    target: a,
                                    start: {
                                        [i]: eh(h, e, "start", Math.max)
                                    },
                                    end: {
                                        [i]: eh(h, e, "end", Math.min)
                                    }
                                })
                            }
                        }
                    ...
                    t.save(), t.fillStyle = c,
                        ...
                        }(t, o, u && eo(n, h, d)), t.beginPath();
                    let g = !!i.pathSegment(t, e);
                    if (u) {
                        g ? t.closePath() : em(t, a, d, n);
            ...
            var ex = {
                ...
                afterDatasetsUpdate(t, e, i) {
                    ...
                    let l = (t.data.datasets || []).length,
                        h = [];
                    for (n = 0; n < l; ++n) r = (a = t.getDatasetMeta(n)).dataset, o = null, r && r.options && r instanceof t8 && (o = {
                        ...
                        fill: function(t, e, i) {
                            ...
                            let o = parseFloat(r);
                            return (0, s.g)(o) && Math.floor(o) === o ? (a = r[0], n = o, ("-" === a || "+" === a) && (n = e + n), n !== e && !(n < 0) && !(n >= i) && n) : ["origin", "start", "end", "stack", "shape"].indexOf(r) >= 0 && r
                        }(r, n, l),
                        chart: t,
                    ...
                    for (n = 0; n < l; ++n)(o = h[n]) && !1 !== o.fill && (o.fill = function(t, e, i) {
                        let a;
                        let n = t[e].fill,
                            r = [e];
                        if (!i) return n;
                ...
                beforeDraw(t, e, i) {
                    ...
                    for (let e = a.length - 1; e >= 0; --e) {
                        let i = a[e].$filler;
                        i && (i.line.updateControlPoints(n, i.axis), s && i.fill && eg(t.ctx, i, n))
                    }
                },
                beforeDatasetsDraw(t, e, i) {
                    ...
                    for (let e = s.length - 1; e >= 0; --e) {
                        let i = s[e].$filler;
                        ec(i) && eg(t.ctx, i, t.chartArea)
                    }
                },
                beforeDatasetDraw(t, e, i) {
                    let s = e.meta.$filler;
                    ec(s) && "beforeDatasetDraw" === i.drawTime && eg(t.ctx, s, t.chartArea)
                },
                defaults: {
                    propagate: !0,
            ...
            let eb = (t, e) => {
                ...
                e_ = (t, e) => null !== t && null !== e && t.datasetIndex === e.datasetIndex && t.index === e.index;
            class ev extends tf {
                constructor(t) {
                ...
                _fitCols(t, e, i, s) {
                    ...
                    return this.legendItems.forEach((t, n) => {
                        ...
                        let {
                            ...
                            itemHeight: (f = e.lineHeight, x = s, "string" != typeof t.text && (x = ey(t, f)), x)
                        };
            ...
            class eA extends tf {
                ...
                getTitle(t, e) {
                    let {
                        callbacks: i
                    } = e, s = eT(i, "beforeTitle", this, t), a = eT(i, "title", this, t), n = eT(i, "afterTitle", this, t), r = [];
                    return r = ek(r, eD(s)), r = ek(r, eD(a)), r = ek(r, eD(n))
                }
                getBeforeBody(t, e) {
                    return ek([], eD(eT(e.callbacks, "beforeBody", this, t)))
                }
                getBody(t, e) {
                    let {
                        callbacks: i
                    ...
                    return (0, s.F)(t, t => {
                        let e = {
                            ...
                            s = eE(i, t);
                        ek(e.before, eD(eT(s, "beforeLabel", this, t))), ek(e.lines, eT(s, "label", this, t)), ek(e.after, eD(eT(s, "afterLabel", this, t))), a.push(e)
                    }), a
                }
                getAfterBody(t, e) {
                    return ek([], eD(eT(e.callbacks, "afterBody", this, t)))
                }
                getFooter(t, e) {
                    let {
                        callbacks: i
                    } = e, s = eT(i, "beforeFooter", this, t), a = eT(i, "footer", this, t), n = eT(i, "afterFooter", this, t), r = [];
                    return r = ek(r, eD(s)), r = ek(r, eD(a)), r = ek(r, eD(n))
                }
                _createItems(t) {
                    let e, i;
                    ...
                    return t.filter && (h = h.filter((e, i, s) => t.filter(e, i, s, n))), t.itemSort && (h = h.sort((e, i) => t.itemSort(e, i, n))), (0, s.F)(h, e => {
                        ...
                        r.push(eT(i, "labelColor", this, e)), o.push(eT(i, "labelPointStyle", this, e)), l.push(eT(i, "labelTextColor", this, e))
                ...
                drawTitle(t, e, i) {
                    ...
                    if (l) {
                        ...
                        for (r = 0, t.x = eL(this, i.titleAlign, i), e.textAlign = h.textAlign(i.titleAlign), e.textBaseline = "middle", a = (0, s.a0)(i.titleFont), n = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string; r < l; ++r) e.fillText(o[r], h.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + n, r + 1 === l && (t.y += i.titleMarginBottom - n)
                    }
                }
                ...
                drawBody(t, e, i) {
                    ...
                    for (e.textAlign = g, e.textBaseline = "middle", e.font = b.string, t.x = eL(this, w, i), e.fillStyle = i.bodyColor, (0, s.F)(this.beforeBody, M), v = p && "right" !== w ? "center" === g ? m / 2 + x : m + 2 + x : 0, o = 0, h = c.length; o < h; ++o) {
                ...
                drawFooter(t, e, i) {
                    ...
                    if (o) {
                        ...
                        for (t.x = eL(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = (0, s.a0)(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, n = 0; n < o; ++n) e.fillText(r[n], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
                    }
                }
                ...
                _updateAnimationTarget(t) {
                    let e = this.chart,
                        ...
                        a = i && i.y;
                    if (s || a) {
                        let i = ew[t.position].call(this, this._active, this._eventPosition);
                        if (!i) return;
                ...
                _positionChanged(t, e) {
                    let {
                        ...
                        caretY: s,
                        options: a
                    } = this, n = ew[a.position].call(this, t, e);
            ...
            let ez = (t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1, s.unshift({
                    index: i,
                    label: e
                })) : isNaN(e) && (i = null), i),
            ...
            class eV extends tw {
                ...
                parse(t, e) {
                    ...
                    return eR(e = isFinite(e) && i[e] === t ? e : function(t, e, i, s) {
                        let a = t.indexOf(e);
                        return -1 === a ? ez(t, e, i, s) : a !== t.lastIndexOf(e) ? i : a
                    ...
                    let t = this.options,
                        ...
                        a = function(t, e) {
                            ...
                            let o = [],
                                ...
                                k = (v - _) / (f + 1),
                                D = (0, s.aH)((v - _) / b / x) * x;
                            if (D < 1e-14 && !y && !M) return [{
                                value: _
                            }, {
                                value: v
                            }];
                            (r = Math.ceil(v / D) - Math.floor(_ / D)) > b && (D = (0, s.aH)(r * D / b / x) * x), (0, s.k)(u) || (D = Math.ceil(D * (i = Math.pow(10, u))) / i), "ticks" === l ? (a = Math.floor(_ / D) * D, n = Math.ceil(v / D) * D) : (a = _, n = v), y && M && h && (0, s.aI)((c - d) / h, D / 1e3) ? (r = Math.round(Math.min((c - d) / D, p)), D = (c - d) / r, a = d, n = c) : w ? (a = y ? d : a, D = ((n = M ? c : n) - a) / (r = g - 1)) : (r = (n - a) / D, r = (0, s.aJ)(r, Math.round(r), D / 1e3) ? Math.round(r) : Math.ceil(r));
                            let P = Math.max((0, s.aK)(D), (0, s.aK)(a));
                            a = Math.round(a * (i = Math.pow(10, (0, s.k)(u) ? P : u))) / i, n = Math.round(n * i) / i;
                            let S = 0;
                            for (y && (m && a !== d ? (o.push({
                                    value: d
                                }), a < d && S++, (0, s.aJ)(Math.round((a + S * D) * i) / i, d, eN(d, k, t)) && S++) : a < d && S++); S < r; ++S) {
                            ...
                            return M && m && n !== c ? o.length && (0, s.aJ)(o[o.length - 1].value, c, eN(c, k, t)) ? o[o.length - 1].value = c : o.push({
                                value: c
                            }) : M && n !== c || o.push({
                                value: n
                            }), o
            ...
            class eY extends tw {
                ...
                parse(t, e) {
                    let i = eB.prototype.parse.apply(this, [t, e]);
                    if (0 === i) {
                        this._zero = !0;
                        return
                    }
                ...
                determineDataLimits() {
                    ...
                    this.min = (0, s.g)(t) ? Math.max(0, t) : null, this.max = (0, s.g)(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !(0, s.g)(this._userMin) && (this.min = t === ej(this.min, 0) ? ej(this.min, -1) : ej(this.min, 0)), this.handleTickRangeOptions()
                }
                handleTickRangeOptions() {
                    let {
                        minDefined: t,
                    ...
                    i === s && (i <= 0 ? (a(1), n(10)) : (a(ej(i, -1)), n(ej(s, 1)))), i <= 0 && a(ej(s, -1)), s <= 0 && n(ej(i, 1)), this.min = i, this.max = s
                }
                buildTicks() {
                    let t = this.options,
                        e = function(t, {
            ...
            class eG extends eB {
                ...
                generateTickLabels(t) {
                    eB.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map((t, e) => {
                ...
                fit() {
                    ...
                    t.display && t.pointLabels.display ? function(t) {
                        ...
                        for (let c = 0; c < r; c++) {
                            ...
                            }(i, e, f, eX(m, u.x, p.w, 0, 180), eX(m, u.y, p.h, 90, 270))
                        }
                ...
                drawBackground() {
                    ...
                    if (t) {
                        let i = this.ctx;
                        i.save(), i.beginPath(), eq(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
                    }
                }
                drawGrid() {
                    let t, e, i;
                    ...
                    if (n.pointLabels.display && function(t, e) {
                            ...
                            if (0 !== i) {
                                ...
                                ! function(t, e, i, s, a) {
                                    ...
                                    (r || s) && o && l && !(i < 0) && (n.save(), n.strokeStyle = o, n.lineWidth = l, n.setLineDash(a.dash), n.lineDashOffset = a.dashOffset, n.beginPath(), eq(t, i, r, s), n.closePath(), n.stroke(), n.restore())
                                }(this, a, e, h, n)
                            }
                        }), r.display) {
                        for (a.save(), t = h - 1; t >= 0; t--) {
                            ...
                            l && o && (a.lineWidth = l, a.strokeStyle = o, a.setLineDash(s.borderDash), a.lineDashOffset = s.borderDashOffset, e = this.getDistanceFromCenterForValue(n.ticks.reverse ? this.min : this.max), i = this.getPointPosition(t, e), a.beginPath(), a.moveTo(this.xCenter, this.yCenter), a.lineTo(i.x, i.y), a.stroke())
                        }
                        a.restore()
                    }
                }
            ...
            class e6 extends tw {
                ...
                buildTicks() {
                    ...
                    let n = this.min,
                        r = this.max,
                        o = (0, s.aO)(a, n, r);
                    return this._unit = e.unit || (i.autoSkip ? e1(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, a) {
                        for (let n = eJ.length - 1; n >= eJ.indexOf(i); n--) {
                            let i = eJ[n];
                            if (eK[i].common && t._adapter.diff(a, s, i) >= e - 1) return i
                        }
                    ...
                    }(this._unit) : void 0, this.initOffsets(a), t.reverse && o.reverse(), e3(this, o, this._majorUnit)
                }
                afterAutoSkip() {
                ...
                _generate() {
                    ...
                    return (t === n || "ticks" === r.bounds || 1 === e) && e2(u, t, p), Object.keys(u).sort(eZ).map(t => +t)
                }
                getLabelForValue(t) {
                    let e = this._adapter,
                        i = this.options.time;
                ...
                _getLabelCapacity(t) {
                    let e = this.options.time,
                        ...
                        a = this._tickFormatFunction(t, 0, e3(this, [t], this._majorUnit), s),
            ...
            class e4 extends e6 {
                static# t = this.id = "timeseries";
                static# e = this.defaults = e6.defaults;
                constructor(t) {
                ...
                initOffsets() {
                    ...
                    this._minPos = e5(e, this.min), this._tableRange = e5(e, this.max) - this._minPos, super.initOffsets(t)
                }
                buildLookupTable(t) {
                    let e, i, s;
                    let {
                ...
                getDecimalForValue(t) {
                    return (e5(this._table, t) - this._minPos) / this._tableRange
                }
                getValueForPixel(t) {
                    let e = this._offsets,
                        i = this.getDecimalForPixel(t) / e.factor - e.end;
                    return e5(this._table, i * this._tableRange + this._minPos, !0)
                }
            }
        }
    }
